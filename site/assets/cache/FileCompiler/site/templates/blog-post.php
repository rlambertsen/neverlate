 ...
 */
    ...
    */
    ...
    // $renderComments = $blogConfigs['commentsUse'] == 1 ? $blog->renderComments($page->blog_comments) : '';. $renderComments 

    $content = $blog->renderPosts($page) . $blog->postAuthor() . $blog->renderNextPrevPosts($page);//with post author widget

    //include the main/common markup
    require_once("blog-single.inc");
